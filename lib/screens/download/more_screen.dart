...
import 'package:netflix_clonee/screens/auth/login_screen.dart';
...
class customProfile extends StatelessWidget {
  const customProfile({super.key, required this.image, required this.name});
  final String image;
  final String name;
  @override
  Widget build(BuildContext context) {
